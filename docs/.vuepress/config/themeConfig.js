...
module.exports = {
  ...
  logo: 'https://i.328888.xyz/2023/04/03/ibiY4C.jpeg', // 导航栏logo
  repo: 'eryajf/Waterland', // 导航栏右侧生成Github链接
  ...
  archive: ture, // 是否打开归档功能，默认true。 如打开，会做的事情有：1.自动生成归档页面（在@pages文件夹）。如关闭，则反之。
  ...
  footer: {
    ...
    copyrightInfo:
      'Eryajf | <a href="https://github.com/eryajf/Waterland/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  }
}